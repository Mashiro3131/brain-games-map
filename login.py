...
class Login(CTkFrame):
    ...
    def register_new_user(self):
        ...
        if self.db.register_user(username, password, role_id=1):  # Assuming role_id=1 for regular users
    ...
    def create_register_frame(self):
        self.register_frame = CTkFrame(self, width=428, height=645, fg_color="#000")
    ...
    def create_register_main_frame(self):
        ...
        self.register_main_frame.pack(expand=True, side="right")
        
        # Register title
        register_title_label = CTkLabel(self.register_main_frame, text="Register", text_color="#d292ff", 
                                        anchor="w", justify="left", font=CTkFont(family="Test Söhne Kräftig", size=41, weight="bold"))
        register_title_label.pack(anchor="w", pady=(75, 55), padx=(55, 0))
    ...
    def setup_register_button_frame(self):
        ...
        self.register_button_frame.pack(anchor="w", pady=(20, 0), padx=(55, 0))
